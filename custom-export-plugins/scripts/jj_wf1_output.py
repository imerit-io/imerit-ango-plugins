...
def jj_wf1_output(**data):
        ...
        try:
            if project_id == "667db48a1c2ced00160539c7":
                expert = "expert_1"
            elif project_id == "669533ec63390e00163a3b73":
                expert = "expert_2"
            elif project_id == "6695340711d2e10015b4e169":
                expert = "expert_3"
...
class Functions:
    ...
    @staticmethod
    def make_csv(df, nrrd_dictionary, expert):
        batches = []
        for key in nrrd_dictionary.keys():
            if key.split("_")[0] not in batches:
                batches.append(key.split("_")[0])
        data = {}
